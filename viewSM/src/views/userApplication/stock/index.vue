<style>
  ...
  .el-tree .el-tree-node__label:hover{ font-weight: bolder; color: #5b94ee; }
</style>
<template>
  <div class="app-container">
    <el-row  type="flex">
      ...
      <el-col
      style="border-right: 1px solid #5b94ee !important;width: 15%">
          ...
          <el-row>
            ...
            <el-col  :span="8" class="stock-con stock-con-add" v-if="undefined != storey.storeyList && storey.storeyList.length>0">
              <el-card :body-style="{ padding: '0px' }" class="stock-card stock-card-add">
                <img src="@/assets/images/moren.png" class="stock-add stock-image" @click="handleStockAdd">
              </el-card>
            </el-col>
          </el-row>
        </div>
