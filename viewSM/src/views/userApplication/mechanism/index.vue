    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="单位地址" prop="addr">
          ...
          <span style="color: #999;font-size: 12px;"><font style="color: #E6A23C;">{{addr.province}}</font><font style="color: #5b94ee;">{{addr.city}}</font><font style="color: #F56C6C;">{{addr.area}}</font>{{addr.other}}</span>
      ...
      <el-row >
        <el-col :span="30">
          <el-image
            ...
            :src="srcItem"
            fit="scale-down"
            style="width:200px;height:200px;margin: 5px;border-radius: 5px;box-shadow: 0 0 2px #5b94ee;"/>
          <el-image
            :key="addUrl"
            :src="addUrl"
            fit="scale-down"
