...
public class BookStockBrowHistoryController extends BaseController {
    ...
    @ApiOperation(value ="查询借书未归还信息列表",notes = "查询借书未归还信息列表")
    ...
    @ApiOperation(value ="借书信息归还操作",notes = "借书信息归还操作")
    ...
    @ApiOperation(value ="查询借书归还记录列表",notes = "查询借书归还记录列表")
    ...
    @ApiOperation(value ="查询归还记录信息明细",notes = "查询归还记录信息明细")
